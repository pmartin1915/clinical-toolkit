      ...
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
          ...
          <ul className="text-sm text-gray-700 space-y-1">
            <li>â€¢ Aim for remission, not just symptom reduction</li>
            <li>â€¢ Both medication and psychotherapy are effective for mild-moderate MDD</li>
            <li>â€¢ Monitor closely for suicidal ideation, especially first 4-6 weeks of treatment</li>
            <li>â€¢ Use shared decision-making considering patient preferences and access</li>
            <li>â€¢ Continue treatment 6-12 months after remission to prevent relapse</li>
          </ul>
        </div>
