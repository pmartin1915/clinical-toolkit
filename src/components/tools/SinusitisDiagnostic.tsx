      ...
      <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
          ...
          <ul className="text-sm text-gray-700 space-y-1">
            <li>â€¢ Most cases of rhinosinusitis are viral and self-limiting</li>
            <li>â€¢ ABRS diagnosis requires â‰¥10 days without improvement OR worsening after initial improvement</li>
            <li>â€¢ Consider imaging only if complications suspected or atypical presentation</li>
            <li>â€¢ Fluoroquinolones should be reserved for severe penicillin allergies</li>
            <li>â€¢ Watchful waiting is appropriate for most cases meeting ABRS criteria</li>
          </ul>
        </div>
