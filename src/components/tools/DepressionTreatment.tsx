            ...
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              {needsEmergencyEvaluation() && (
                <div className="mt-4 p-3 bg-red-100 border border-red-300 rounded-lg">
                  <p className="text-red-900 font-bold">⚠️ EMERGENCY EVALUATION REQUIRED</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  ...
                  { key: 'hasWeightConcerns', label: 'Weight gain concerns', icon: '⚖️' },
                  ...
                  { key: 'hasLowAppetite', label: 'Low appetite/weight loss', icon: '🍽️' },
