...
# This script redirects to the new location: scripts/android/android-test-device.ps1
#
...
Write-Host "Redirecting to: scripts\android\android-test-device.ps1" -ForegroundColor Gray
Write-Host ""

$newScriptPath = Join-Path $PSScriptRoot "android\android-test-device.ps1"
