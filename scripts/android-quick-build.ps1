...
# This script redirects to the new location: scripts/android/android-quick-build.ps1
#
...
Write-Host "Redirecting to: scripts\android\android-quick-build.ps1" -ForegroundColor Gray
Write-Host ""

$newScriptPath = Join-Path $PSScriptRoot "android\android-quick-build.ps1"
